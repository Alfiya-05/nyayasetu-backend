...
const HearingSchema = new mongoose_1.Schema({
    ...
    citizenId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User' },
...
exports.default = mongoose_1.default.model('Hearing', HearingSchema);
